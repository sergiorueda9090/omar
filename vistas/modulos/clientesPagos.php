...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar clientes pagos</li>
        ...
        <?php
          ...
          foreach ($clientes as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td style="background:#e6f1be85;color:#c59c08;text-align:center;margin:auto;font-family: Source Sans Pro, sans-serif;font-size: 17px;"><strong>PAGO</strong></td>
                    ...
                    <td style="text-align:center;">
                      ...
                      if($_SESSION["perfil"] == "Administrador"){
                          ...
                          echo '<button type="button" class="btn btn-outline-info"><a href="index.php?ruta=tarjetaCliente&id='.$value["id"].'&estado=PAGO"" style="position:relative; z-index:1"><i class="fa fa-calendar"></i></a></button>';
