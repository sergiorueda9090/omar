...
class TCPDF {
		...
		switch($dest) {
			case 'I': {
				...
				if (php_sapi_name() != 'cli') {
					...
					//header('Cache-Control: public, must-revalidate, max-age=0'); // HTT1.1
	...
	protected function _putXMP() {
		...
		$xmp .= "\t\t".'<rdf:Description rdf:about="" xmlns:xmp="http://ns.adobe.com/xa1.0/">'."\n";
		...
		$xmp .= "\t\t".'</rdf:Description>'."\n";
		$xmp .= "\t\t".'<rdf:Description rdf:about="" xmlns:xmpMM="http://ns.adobe.com/xa1.0/mm/">'."\n";
		...
		$xmp .= "\t\t\t\t\t".'</rdf:li>'."\n";
		$xmp .= "\t\t\t\t\t".'<rdf:li rdf:parseType="Resource">'."\n";
		$xmp .= "\t\t\t\t\t\t".'<pdfaSchema:namespaceURI>http://ns.adobe.com/xa1.0/mm/</pdfaSchema:namespaceURI>'."\n";
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	/**
	 * Set the tobottom cell sides to be open or closed when the cell cross the page.
	 * @param $isopen (boolean) if true keeps the tobottom border open for the cell sides that cross the page.
	 * @public
	 * @since 4.2.010 (2008-11-14)
	 */
