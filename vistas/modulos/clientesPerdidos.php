...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar clientes perdidos</li>
        ...
        <?php
          ...
          foreach ($clientes as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td style="background:#fbc4c4;color:#f50505;text-align:center;margin:auto;font-family: Source Sans Pro, sans-serif;font-size: 17px;"><strong>PERDIDOS</strong></td>
                    ...
                    <td style="text-align:center;">
                      ...
                      if($_SESSION["perfil"] == "Administrador"){
                          ...
                          echo '<button type="button" class="btn btn-outline-info"><a href="index.php?ruta=tarjetaCliente&id='.$value["id"].'&estado=PERDIDO"" style="position:relative; z-index:1"><i class="fa fa-calendar"></i></a></button>';
